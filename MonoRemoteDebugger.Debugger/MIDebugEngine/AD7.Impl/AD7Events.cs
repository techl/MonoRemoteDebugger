...
namespace Microsoft.MIDebugEngine
{
    ...
    internal sealed class AD7BreakpointBoundEvent : AD7AsynchronousEvent, IDebugBreakpointBoundEvent2
    {
        ...
        public AD7BreakpointBoundEvent(AD7PendingBreakpoint pendingBreakpoint, AD7BoundBreakpoint boundBreakpoint = null)//bhlee
        {
    ...
    internal sealed class AD7BreakpointEvent : AD7StoppingEvent, IDebugBreakpointEvent2
    {
        ...
        private readonly AD7PendingBreakpoint _breakpoint;
        public AD7BreakpointEvent(AD7PendingBreakpoint breakpoint)
        {
